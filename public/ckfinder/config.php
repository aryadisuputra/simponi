...
// Production
require_once __DIR__ . "/../../app/functions/Default.php";
...
$config['licenseKey']  = '*5?7-*1**-F**1-*F**-*8**-3*E*-2**F';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://localhost/simponi/public/uploads',
    'root'         => __DIR__ . '/../uploads', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
